...
import { User, Shield, Bell, Camera, CheckCircle, AlertCircle, Smartphone, Mail } from "lucide-react";
...
export default function CustomerProfilePage() {
  ...
  // Bildirimler
  const [notifClaimUpdate,   setNotifClaimUpdate]   = useState(true);
  const [notifClaimApproved, setNotifClaimApproved] = useState(true);
  ...
  function handleSaveNotifications() {
    ...
    localStorage.setItem(key, JSON.stringify({ notifClaimUpdate, notifClaimApproved, notifEmail, notifBrowser }));
    setNotifSaved(true);
                ...
                <div className="flex items-center justify-end gap-3 border-t border-gray-100 pt-4">
                  <button
                    onClick={() => {
                      ...
                      setNewPass(""); setConfirmPass(""); setFeedback(null);
                    }}
                    ...
                    {twoFaMethod === "email" && (
                      <div>
                        ...
                        <input
                          ...
                          placeholder="dogrulama@mail.com"
                          className={inputCls}
                        />
            ...
            {section === "notifications" && (
              <>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {[
                    {
                      label: "Hasar Kaydı Güncellemeleri",
                      desc:  "Hasar kaydınızın durumu değiştiğinde bildirim al",
                      value: notifClaimUpdate,
                      set:   setNotifClaimUpdate,
                    },
                    {
                      label: "Hasar Onayı / Reddi",
                      desc:  "Hasar başvurunuz onaylandığında veya reddedildiğinde bildirim al",
                      value: notifClaimApproved,
                      set:   setNotifClaimApproved,
                    },
